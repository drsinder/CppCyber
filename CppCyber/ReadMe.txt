...
**	sinder@illinoois.edu
**
**  Name: ReaadMe.txt
**
**  Description:
**      This file describes the modifications made to the program
**
...
**--------------------------------------------------------------------------
*/========================================================================
    CONSOLE APPLICATION : CppCyber Project Overview
========================================================================

AppWizard has created this CppCyber application for you.

This file contains a summary of what you will find in each of the files that
make up your CppCyber application.
...
StdAfx.h, StdAfx.cpp
    ...
    named CppCyber.pch and a precompiled types file named StdAfx.obj.
...
sections other than [cyber] require two copies.  The usual
for mainframe 0 and another with a name same as the MF 0 
section but with a "1" appended:
