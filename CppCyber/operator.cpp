...
**
**  Parameters:     Name        Description.
**                  help		true if help needed or requested
**					params		channel and unit number
**
**  Returns:        Nothing
**
**------------------------------------------------------------------------*/
static void opCmdDumpDisk(bool help, char *cmdParams)
{
	/*
	**  Process help request.
	*/
	...
	*/
	...
	dd8xxDumpDisk(cmdParams);
}

static void opHelpDumpDisk(void)
{
	printf("'dump_disk <mainframe>,<channel>,<unit>' dump a physical disk.\n");
	printf("MUST run ONLY after startup and BEFORE deadstart!!\n");
	printf("Then shutdown!!\n");
